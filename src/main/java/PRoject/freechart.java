...
public class freechart extends JPanel {
 ...
 @param legende : vrai si on affiche la légende
	*/
	...
	public freechart(String titre, String abscisse, String ordonnee, Color fond, List<String> listeSeries, List<String> listeCategory, boolean legende,List<Float> valeurs) {
...
//		{
//			donnees.add((float) donnees.get(i));
//	
//		}
//		
//		
